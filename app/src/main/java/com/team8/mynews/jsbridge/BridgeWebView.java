...
public class BridgeWebView extends WebView
        implements com.team8.mynews.jsbridge.LvUJsBridge {

    private final String TAG = "BridgeWebView";

    String toLoadJs = "LvUJsBridge.js";
    Map<String, com.team8.mynews.jsbridge.CallBackFunction> responseCallbacks = new HashMap<String, com.team8.mynews.jsbridge.CallBackFunction>();
    Map<String, com.team8.mynews.jsbridge.BridgeHandler> messageHandlers = new HashMap<String, com.team8.mynews.jsbridge.BridgeHandler>();
    com.team8.mynews.jsbridge.BridgeHandler defaultHandler = new com.team8.mynews.jsbridge.DefaultHandler();
     ...
     */
    public void setDefaultHandler(com.team8.mynews.jsbridge.BridgeHandler handler) {
...
//			this.setLayerType(View.LAYER_TYPE_SOFTWARE, null);
    ...
    private void handlerReturnData(String url) {
        ...
        com.team8.mynews.jsbridge.CallBackFunction f = responseCallbacks.get(functionName);
...
//			handler.cancel();
    ...
    private void doSend(String handlerName, String data, com.team8.mynews.jsbridge.CallBackFunction responseCallback) {
    ...
    public void flushMessageQueue() {
        if (Thread.currentThread() == Looper.getMainLooper().getThread()) {
            loadUrl(BridgeUtil.JS_FETCH_QUEUE_FROM_JAVA, new com.team8.mynews.jsbridge.CallBackFunction() {
                ...
                public void onCallBack(String data) {
                    ...
                    for (int i = 0; i < list.size(); i++) {
                        ...
                        if (!TextUtils.isEmpty(responseId)) {
                            com.team8.mynews.jsbridge.CallBackFunction function = responseCallbacks.get(responseId);
                            String responseData = m.getResponseData();
                            function.onCallBack(responseData);
                            responseCallbacks.remove(responseId);
                        } else {
                            com.team8.mynews.jsbridge.CallBackFunction responseFunction = null;
                            // if had callbackId
                            final String callbackId = m.getCallbackId();
                            if (!TextUtils.isEmpty(callbackId)) {
                                responseFunction = new com.team8.mynews.jsbridge.CallBackFunction() {
                                    @Override
                                    public void onCallBack(String data) {
                            ...
                            com.team8.mynews.jsbridge.BridgeHandler handler;
    ...
    public void loadUrl(String jsUrl, com.team8.mynews.jsbridge.CallBackFunction returnCallback) {
        this.loadUrl(jsUrl);
     ...
     * @param handler
     */
    public void registerHandler(String handlerName, com.team8.mynews.jsbridge.BridgeHandler handler) {
        if (handler != null) {
     ...
     * @param callBack
     */
    public void callHandler(String handlerName, String data, com.team8.mynews.jsbridge.CallBackFunction callBack) {
